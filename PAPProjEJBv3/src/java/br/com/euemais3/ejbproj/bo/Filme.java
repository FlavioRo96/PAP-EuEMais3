...
@NamedQueries({
    @NamedQuery(name = "consultarTodos.Filme", query = "select f from Filme f")
})
...
//    }
    ...
    public Filme(Long id, String nome, String sinopse, Date anoProducao, String direcao, String distribuidor, Date duracao) {
        this.id = id;
        this.nome = nome;
        this.sinopse = sinopse;
        this.anoProducao = anoProducao;
